...
//        graphicsControlExtensionNode.setAttribute("disposalMethod", "none");不重置背景
        graphicsControlExtensionNode.setAttribute("disposalMethod", "restoreToBackgroundColor");//每一帧重置背景
